...
#define	REG00_Minimal_System_Voltage	0x0		//		RW													// DS. p. 55 - 7.5.1.1
#define	REG01_Charge_Voltage_Limit		0x1		//		RW											// DS. p. 56 - 7.5.1.2
#define	REG03_Charge_Current_Limit		0x3		//		RW											// DS. p. 57 - 7.5.1.3
#define	REG05_Input_Voltage_Limit		0x5		//		RW											// DS. p. 58 - 7.5.1.4
#define	REG06_Input_Current_Limit		0x6		//		RW											// DS. p. 59 - 7.5.1.5
#define	REG08_Precharge_Control			0x7		//		RW											// DS. p. 60 - 7.5.1.6
#define	REG09_Termination_Control		0x8		//		RW											// DS. p. 61 - 7.5.1.7
#define 	REG_RST							6
#define	REG0A_Re_charge_Control			0xA		//		RW											// DS. p. 62 - 7.5.1.8
#define	REG0B_VOTG_regulation			0xB		//		RW											// DS. p. 63 - 7.5.1.9
#define	REG0D_IOTG_regulation			0xD		//		RW											// DS. p. 64 - 7.5.1.10
#define 	PRECHG_TMR						7
#define	REG0E_Timer_Control				0xE		//		RW											// DS. p. 65 - 7.5.1.11
#define 	EN_TRICHG_TMR					5
#define 	EN_PRECHG_TMR					4
#define 	EN_CHG_TMR						3
#define 	TMR2X_EN						0
#define	REG0F_Charger_Control_0			0xF		//		RW											// DS. p. 66 - 7.5.1.12
...
#define		EN_HIZ							2
#define		EN_TERM							1
#define	REG10_Charger_Control_1			0x10	//		RW										// DS. p. 67 - 7.5.1.13
#define 	WD_RST							3
#define	REG11_Charger_Control_2			0x11	//		RW											// DS. p. 68 - 7.5.1.14
...
#define 	HVDCP_EN						3
#define 	SDRV_DLY						0
#define	REG12_Charger_Control_3			0x12	//		RW											// DS. p. 69 - 7.5.1.15
#define 	DIS_ACDRV						7
#define 	EN_OTG							6
...
#define	REG13_Charger_Control_4			0x13	//		RW											// DS. p. 70 - 7.5.1.16
#define		EN_ACDRV2						7
#define		EN_ACDRV1						6
#define		PWM_FREQ						5
#define		DIS_STAT						4
...
#define	REG14_Charger_Control_5			0x14	//		RW											// DS. p. 72 - 7.5.1.17
#define		SFET_PRESENT					7
#define		EN_IBAT							5
#define		EN_IINDPM						2
#define		EN_EXTILIM						1
#define		EN_BATOC						0
#define	REG15_MPPT_Control				0x15	//		RW											// DS. p. 73 - 7.5.1.18
#define		EN_MPPT							0
#define	REG16_Temperature_Control		0x16	//		RW											// DS. p. 74 - 7.5.1.19
#define		VBUS_PD_EN						3
#define		VAC1_PD_EN						2
#define		VAC2_PD_EN						1
#define	REG17_NTC_Control_0				0x17	//		RW											// DS. p. 75 - 7.5.1.20
#define	REG18_NTC_Control_1				0x18	//		RW											// DS. p. 76 - 7.5.1.21
#define		BCOLD							1
#define		TS_IGNORE						0
#define	REG19_ICO_Current_Limit			0x19	//		R											// DS. p. 77 - 7.5.1.22
#define	REG1B_Charger_Status_0			0x1B	//		R											// DS. p. 78 - 7.5.1.23
...
#define	REG1C_Charger_Status_1			0x1C	//		R											// DS. p. 80 - 7.5.1.24
#define		BC12_DONE_STAT					0
#define	REG1D_Charger_Status_2			0x1D	//		R											// DS. p. 81 - 7.5.1.25
#define		TREG_STAT						2
#define		DPDM_STAT						1
#define		VBAT_PRESENT_STAT				0
#define	REG1E_Charger_Status_3			0x1E	//		R											// DS. p. 82 - 7.5.1.26
#define		ACRB2_STAT						7
#define		ACRB1_STAT						6
...
#define	REG21_FAULT_Status_1			0x21	//		R											// DS. p. 86 - 7.5.1.29
#define		VSYS_SHORT_STAT					7
#define		VSYS_OVP_STAT					6
#define		OTG_OVP_STAT					5
#define		OTG_UVP_STAT					4
#define		TSHUT_STAT						2
#define	REG22_Charger_Flag_0			0x22	//		R											// DS. p. 87 - 7.5.1.30
...
#define	REG23_Charger_Flag_1			0x23	//		R											// DS. p. 89 - 7.5.1.31
#define		CHG_FLAG						7
#define		ICO_FLAG						6
#define		VBUS_FLAG						4
#define		TREG_FLAG						2
...
#define	REG24_Charger_Flag_2			0x24	//		R											// DS. p. 90 - 7.5.1.32
...
#define	REG27_FAULT_Flag_1				0x27	//		R											// DS. p. 94 - 7.5.1.35
#define		VSYS_SHORT_FLAG					7
#define		VSYS_OVP_FLAG					6
#define		OTG_OVP_FLAG					5
#define		OTG_UVP_FLAG					4
#define		TSHUT_FLAG						2
#define	REG28_Charger_Mask_0			0x28	//		RW											// DS. p. 95 - 7.5.1.36
...
#define	REG29_Charger_Mask_1			0x29	//		RW											// DS. p. 97 - 7.5.1.37
#define		CHG_MASK						7
#define		ICO_MASK						6
#define		VBUS_MASK						4
#define		TREG_MASK						2
...
#define	REG2A_Charger_Mask_2			0x2A	//		RW											// DS. p. 98 - 7.5.1.38
...
#define	REG2D_FAULT_Mask_1				0x2D	//		RW											// DS. p. 101 - 7.5.1.41
#define		VSYS_SHORT_MASK					7
#define		VSYS_OVP_MASK					6
#define		OTG_OVP_MASK					5
#define		OTG_UVP_MASK					4
#define		TSHUT_MASK						2
#define	REG2E_ADC_Control				0x2E	//		RW											// DS. p. 102 - 7.5.1.42
#define		ADC_EN							7
#define		ADC_RATE						6
#define		ADC_AVG							3
#define		ADC_AVG_INIT					2
#define	REG2F_ADC_Function_Disable_0	0x2F	//		RW											// DS. p. 103 - 7.5.1.43
...
#define	REG30_ADC_Function_Disable_1	0x30	//		RW											// DS. p. 104 - 7.5.1.44
#define		DP_ADC_DIS						7
#define		DM_ADC_DIS						6
#define		VAC2_ADC_DIS					5
#define		VAC1_ADC_DIS					4
#define	REG31_IBUS_ADC					0x31	//		R											// DS. p. 105 - 7.5.1.45
#define	REG33_IBAT_ADC					0x33	//		R											// DS. p. 106 - 7.5.1.46
#define	REG35_VBUS_ADC					0x35	//		R											// DS. p. 107 - 7.5.1.47
#define	REG37_VAC1_ADC					0x37	//		R											// DS. p. 108 - 7.5.1.48
#define	REG39_VAC2_ADC					0x39	//		R											// DS. p. 109 - 7.5.1.49
#define	REG3B_VBAT_ADC					0x3B	//		R											// DS. p. 110 - 7.5.1.50
#define	REG3D_VSYS_ADC					0x3D	//		R											// DS. p. 111 - 7.5.1.51
#define	REG3F_TS_ADC					0x3F	//		R											// DS. p. 112 - 7.5.1.52
#define	REG41_TDIE_ADC					0x41	//		R											// DS. p. 113 - 7.5.1.53
#define	REG43_DP_ADC					0x43	//		R											// DS. p. 114 - 7.5.1.54
#define	REG45_DN_ADC					0x45	//		R											// DS. p. 115 - 7.5.1.55
#define	REG47_DPDM_Driver				0x47	//		RW											// DS. p. 116 - 7.5.1.56
#define	REG48_Part_Information			0x48	//		R											// DS. p. 117 - 7.5.1.57
