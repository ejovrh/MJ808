...
def start_reading():
    ...
    dropdown["state"] = "readonly"  # Enable the Combobox state="disabled"
...
def stop_reading():
    ...
    dropdown["state"] = "disabled"  # disable the Combobox
...
dropdown = Combobox(dropdown_frame, textvariable=dropdown_var, height=10, values=sorted_items, state="disabled")
sorted_items = sorted(register_bit_name.keys())
dropdown['values'] = sorted_items
dropdown_var.set("Select a bit")
dropdown.bind("<<ComboboxSelected>>", onDropdownSelection)
