...
{
	HAL_GPIO_WritePin(Motor_CW_Direction_GPIO_Port, Motor_CW_Direction_Pin, GPIO_PIN_SET);
	;
}

static void _RotateDown(void)
{
	HAL_GPIO_WritePin(Motor_CCW_Direction_GPIO_Port, Motor_CCW_Direction_Pin, GPIO_PIN_SET);
	;
}
