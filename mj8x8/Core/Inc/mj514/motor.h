 ...
 *		this worm gear rotates an idler gear which then rotates the "40-tooth e14 gear".
 *			the "40-tooth e14 gear" actuates the "17 tooth rohloff gear", which then does the actual shifting in the hub.
 *		the "40-tooth e14 gear" drives the "23-tooth magnetic gear".
 *
 ...
 *			- 1024 * 0.1055...  = 108.1242 impulses, with an ABM setting of 0x8
