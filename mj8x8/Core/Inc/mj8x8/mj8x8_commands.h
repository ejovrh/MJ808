...
#define CANID_ANY (PRIORITY_HIGH | UNICAST | RCPT_DEV_CLASS_BLANK | SENDER_DEV_CLASS_BLANK | SENDER_DEV_BLANK)	// 0x00
#define CANID_MJ808 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_LIGHT | RCPT_DEV_CLASS_BLANK | SENDER_DEV_A)	// 0xA0
#define CANID_MJ818 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_LIGHT | RCPT_DEV_CLASS_BLANK | SENDER_DEV_B)	// 0xA4
#define CANID_MJ828 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_LU | RCPT_DEV_CLASS_BLANK | SENDER_DEV_D)	// 0x8C
#define CANID_MJ838 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_PWR_SRC | RCPT_DEV_CLASS_BLANK | SENDER_DEV_A)	// 0x90
