...
// CAN ID upper byte construction -- sender format (i.e. recipient is zero -> broadcast)
#define CANID_ANY (PRIORITY_HIGH | UNICAST | RCPT_DEV_CLASS_BLANK | SENDER_DEV_CLASS_BLANK | SENDER_DEV_BLANK)	// 0x0000
#define CANID_MJ808 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_LIGHT | RCPT_DEV_CLASS_BLANK | SENDER_DEV_A)	// 0xA000
#define CANID_MJ818 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_LIGHT | RCPT_DEV_CLASS_BLANK | SENDER_DEV_B)	// 0xA400
#define CANID_MJ828 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_LU | RCPT_DEV_CLASS_BLANK | SENDER_DEV_D)	// 0x8C00
#define CANID_MJ838 (PRIORITY_LOW | UNICAST | SENDER_DEV_CLASS_PWR_SRC | RCPT_DEV_CLASS_BLANK | SENDER_DEV_A)	// 0x9000
