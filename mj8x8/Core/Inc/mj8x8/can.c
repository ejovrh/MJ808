...
// ch12.6 & table 12.5
static
void __mcp2515_opcode_load_tx_buffer(const uint8_t buffer, volatile const uint8_t *data, const uint8_t len)
{
//	uint8_t i;
//	gpio_clr(SPI_SS_MCP2515_pin);										// select the slave
//
...
//	{
//// PRT - 		_mcp2515_opcode_bit_modify(CANINTF, _BV(MERRF), 0x00);		// clear the flag
//	}
//	;
//
...
//	{
//// PRT - 		_mcp2515_opcode_bit_modify(CANINTF, _BV(ERRIF), 0x00);	// clear the error interrupt flag
//		/*
...
//			switch(__CAN.__icod)
//				// handling of cases depending on ICOD value - sort of priority-style
