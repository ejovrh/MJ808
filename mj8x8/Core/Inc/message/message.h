...
{  //
	...
	void (*const SendMessage)(mj8x8_Devices_t in_rcpt, const uint8_t in_command, const uint8_t in_argument, const uint8_t in_len);  // loads outbound CAN message into local CAN IC and asks it to transmit it onto the bus
