...
gpio_conf(SPI_MOSI_pin, OUTPUT, LOW); // FIXME: pins are swapped, needs to be updated in the schematic
gpio_conf(SPI_MISO_pin, INPUT, LOW); // FIXME: pins are swapped, needs to be updated in the schematic
